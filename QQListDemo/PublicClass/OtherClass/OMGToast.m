...
- (id)initWithText:(NSString *)text_{  
    if (self = [super init]) {  
        ...
        CGSize textSize = [text boundingRectWithSize:CGSizeMake(280, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:attribute context:nil].size;
...
- (void)showOnThread{  
    ...
    [window  addSubview:contentView];  
    [self showAnimation];  
    [self performSelectorOnMainThread:@selector(hideAnimationOnMain) withObject:nil waitUntilDone:NO];  
}
